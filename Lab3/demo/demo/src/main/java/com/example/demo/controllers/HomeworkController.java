...
public class HomeworkController {
    ...
    public ResponseEntity params(@PathVariable("someValue") String value, @RequestParam("query") String query){
    ...
    public ResponseEntity oldPerson (@PathVariable("somePerson") String number, @RequestBody Person person){
        return ResponseEntity.ok(person);
    }
